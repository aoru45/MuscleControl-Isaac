...
class RobotState:
    ...
    def __eq__(self, other: "RobotState") -> bool:
        def _eq(a, b):
        ...
        return (
            _eq(self.root_pos, other.root_pos) and
            _eq(self.root_rot, other.root_rot) and
            _eq(self.root_vel, other.root_vel) and
            _eq(self.root_ang_vel, other.root_ang_vel) and
            _eq(self.dof_pos, other.dof_pos) and
            _eq(self.dof_vel, other.dof_vel) and
            _eq(self.rigid_body_pos, other.rigid_body_pos) and
            _eq(self.rigid_body_rot, other.rigid_body_rot) and
            _eq(self.rigid_body_vel, other.rigid_body_vel) and
            _eq(self.rigid_body_ang_vel, other.rigid_body_ang_vel) and
            _eq(self.key_body_pos, other.key_body_pos)
        )
